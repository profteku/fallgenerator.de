...
function slideup(el) {
    ...
    elem.style.transform = "translateY(calc(-1 * (100vh - 100px)";
    //elem.style.top = "auto";
...
function plot(klappe) {
    //Klappentextflip
    var plottext = document.getElementById(klappe);
    plottext.style.transform = "rotateY(180deg)";
